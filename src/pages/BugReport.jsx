...
export default function BugReport() {
    ...
    return (
        <>
            <div className="sm:py-3 py-5 px-10 sm:px-6 flex justify-between items-center">
            ...
            <div className="grid grid-cols-12 gap-8 my-6 mx-20 sm:mx-6">
                <div className="col-span-4 md:col-span-12 lg:col-span-4">
                    <div className="card-theme p-6 rounded-md">
                        ...
                        <div className="text-sm mt-1">
                            Please provide the steps of how to reproduce the
                            bug.
                        </div>
                        <div className="flex items-center mt-3">
                            <IconPaperclip />
                        ...
                        <div className="text-sm mt-1">
                            What web browser and device did you encounter the
                            bug on.
                        </div>
                        <div className="flex items-center mt-3">
                            <IconPaperclip />
                        ...
                        <Button
                            ...
                            icon={<IconGithubLogo />}
                            style={{
                                backgroundColor: "#239144",
                                color: "white",
                            }}
                            onClick={() => {
                                window.open(
                                    `${socials.github}/issues`,
                                    "_self",
                                );
                            }}
                        >
                ...
                <div className="col-span-8 md:col-span-12 lg:col-span-8">
                    <Banner
                        ...
                        description={
                            <div>
                                We value your feedback! If you&apos;ve
                                encountered a bug or issue while using our
                                platform, please help us improve by reporting
                                it. Your input is invaluable in making our
                                service better.
                            </div>
                        }
                    />
